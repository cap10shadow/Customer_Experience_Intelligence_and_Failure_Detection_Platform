...
async def send_copilot_message(client: httpx.AsyncClient, request: CopilotQueryRequest) -> CopilotResponse:
    """
    ...
    response = await post_json(client, f"{settings.COPILOT_SERVICE_URL}/api/v1/copilot/messages", json=body)
