...
instrument_app(app, service_name="anomaly_service", refresh_readiness=lambda: readiness_check("anomaly_service"))
mount_readiness(app, service_name="anomaly_service")
