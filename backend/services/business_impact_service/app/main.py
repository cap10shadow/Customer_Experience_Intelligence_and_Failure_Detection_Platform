...
instrument_app(
    app, service_name="business_impact_service", refresh_readiness=lambda: readiness_check("business_impact_service")
)
mount_readiness(app, service_name="business_impact_service")
