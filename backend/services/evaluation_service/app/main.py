...
instrument_app(app, service_name="evaluation_service", refresh_readiness=lambda: readiness_check("evaluation_service"))
mount_readiness(app, service_name="evaluation_service")
mount_unhandled_exception_logging(app)
init_tracing("evaluation_service", app, engine=engine)
